...
<body>
    ...
    <form action="addTask" method="post">
        ...
        <label>Time Duration: </label><input type="text" name="timeDuration"><br>
    ...
    <ul>
        <%
            ...
            try {
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb2", "root", "Wj28@krhps");

                String sql = "SELECT * FROM Task WHERE user_id=(SELECT id FROM Employee WHERE username=?)";
